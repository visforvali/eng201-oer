...
- I have already identified and separated weekly tasks in the modules
...
- I only do weekly check-ins via Discord, due to my own access needs and to easily link you to specific posts/channels from weekly discussion. You'll receive feedback on your learning in #🙋classroom during our discussions each week, in #team channels during workshop, and on Classes after submitting essay drafts
 - If you select the role that indicates a preference for email communication, I'll email you if I have any other reason to contact you (like a participation issue, or if your low-stakes posts can't be accepted for credit); however, weekly check-ins will still transpire on Discord
 - If you prefer Discord, I'll communicate with you through DMs or voice notes if I have a reason to contact you
 - *Note*: I am much faster on Discord. If you prefer email, please note I reply to emails within 48 hrs and never on weekends. Also, email can't replace our Discord classroom, so get into the habit of checking the app daily. Installing the desktop and mobile apps might make this (plus working on-the-go!) easier
- In a full class setting, I'm unable to send frequent, tailored reminders for work already outlined in the materials. Any reminders I am able to send will be automated through Discord. Any other reminders will be posted to both #🙋classroom and [Classes\Announcements](https://classes.pace.edu/){:target="_blank"} (so make sure you've set up Classes to forward announcements to your email if email is your communication preference)
