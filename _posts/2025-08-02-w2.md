...
To help with various access needs, including task identification and separation and advance notice, I'll include a running list of tasks at the top of each weekly module. (You can check these items off, but your input won't be saved after you close this window.)
