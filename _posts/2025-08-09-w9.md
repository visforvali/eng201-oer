...
<div>
  <input type="checkbox" name="uchk">
  <label for="uchk">Read/watch the material in this module, including these external resources: Meriam Library's "Applying the CRAAP Test," Marshall University Library's "IF I APPLY," Carillo's "Working with Sources," Pacheco-Vega's "How to Do a Literature Review" and "Conceptual Synthesis Excel Dump," and The Research Methods Consortium's "Annotating Sources"</label>
</div>
<div>
  <input type="checkbox" name="uchk">
...
> ###### 🛑 Stop: Revisit!
> If you haven't been taking notes on my responses and feedback every weke, revisit my posts in #🙋classroom (easily retrieved by searching for my username), as well as the feedback from me and the Pace librarian in #📚ask-a-librarian-lit-rvw. Read my replies to *everyone*, not just to you. 
{:.block-tip}
...
Aim for conceptual saturation, which Pacheco-Vega defines as "the point where I am seeing the same citations repeated on a regular basis. I borrow this term from qualitative research methods, as it is also the point when you are seeing the same concepts repeated over and over again."
...
> ###### 🛑 Stop: Read!
> Read Ellen Carillo's [Working with Sources](https://wacclearinghouse.org/docs/books/mindful/chapter5.pdf){:target="_blank"} chapter and Pacheco-Vega's [How to Do a Literature Review: Citation Tracing, Concept Saturation and Results' Mind-Mapping](../assets/pdfs/raul_pacheco-vega_how_to_do_lit_review_citation_tracing_concept_saturation_mind-mapping.pdf){:target="_blank"}.
{:.block-tip}
...
> ###### 🛑 Stop: Read!
> Read this chapter on [Annotating Sources](https://uta.pressbooks.pub/advancedresearchmethodsinsw/chapter/6-4-annotating-sources/){:target="_blank"}! 
{:.block-tip}
