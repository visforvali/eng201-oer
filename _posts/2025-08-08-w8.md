...
> This is Module 8: Understanding the Lit Review, which should be completed between 10/18-10/24. If you haven't completed everything in Module 7, go back and finish all outstanding tasks now. **Don't forget to click on and review each resource in this guide.**
{: .block-danger }

# Goals and Checklist

- Refresh your understanding of how to read scholarly articles
...
<div>
  <input type="checkbox" name="uchk">
  <label for="uchk">Read/watch the material in this module, including these external resources: ENG 201 Assignments, Pace Library Literature Review Tutorial, NCSU's "Understanding the Lit Review," Purdue OWL's "Writing a Literature Review," and NCSU's "Anatomy of a Scholarly Article"</label>
</div>
<div>
  <input type="checkbox" name="uchk">
...
> ###### 🛑 Stop: Reread!
> Revisit the [Assignments](/eng201-oer/pages/assignments){:target="_blank"} page and review the Qualitative Research Project guidelines, especially the guidelines for Unit 2.
{:.block-tip}

In a literature review, *literature* refers to a collection of all the scholarly writings on a topic; *review* indicates that the writer has done a fairly thorough assessment of that collection of scholarship. The literature review allows you to situate your research in a longer trajectory of research about your discipline and point to gaps in that trajectory as a justification for the study you're conducting.
...
A literature review isn't just a series of descriptive summaries. It's intended to demonstrate that you read, evaluated, analyzed, and synthesized all the sources you chose, meaning that you must also identify, establish, and discuss the relationships between those sources.
...
> This week's posts are time-bound since we have a librarian visiting us; like workshops, this week's low-stakes posts will not be counted under the late grace period.
{:.block-danger}
...
The above resources from NCSU and Purdue OWL provide further information on understanding and writing literature reviews.
...
> ###### 🛑 Stop: Watch:
> NCSU's [Anatomy of a Scholarly Article](https://www.lib.ncsu.edu/tutorials/scholarly-articles){:target="_blank"} video walks you through the various components of a traditional academic article &mdash; you can also click the dropdown menu to show the information in a table, or review [this interactive mouseover version](https://www.lib.ncsu.edu/tutorials/scholarly-articles/archive/){:target="_blank"} as well.
{:.block-tip}
...
> ###### Important!
> Some of these parts also indicate whether or not the article in question is peer-reviewed scholarship or a popular publication, including the title of the journal in which the article was published, keywords, or whether or not there's an abtract. 
{:.block-warning}
...
Review the locations and purposes of each of these components and keep them in mind as you read through 
...
Dr. Mani's ENG 201 | [Assignments](https://visforvali.github.io/eng201-oer/pages/assignments/){:target="_blank"} 
...
> ###### Finished? 🥳
> Have you completed everything in this module, including any practice writing activities and low-stakes Discord posts? If you did, congratulations on completing Module 8, and take a well-deserved break! If not, go back and finish what you skipped. In either case, don't forget to begin the next module by Sunday!
{: .block-warning }