...
<div>
  <input type="checkbox" name="uchk">
  <label for="uchk">Select 1 potential blogs/vlogs by prominent members of your discipline, in case you can't secure all 3 interviews</label>
</div>
<div>
  <input type="checkbox" name="uchk">
...
> ###### Important!
> Don't forget to review your Draft 3 (Unit 2 Draft 1) scores along with the updated [General Feedback](https://visforvali.github.io/eng201-oer/pages/feedback/){:target="_blank"} page (TBD by Sunday)
{:.block-danger}
