...
<div>
    <input type="checkbox" name="uchk">
    <label for="chk">Review the [📋 Syllabus](https://visforvali.github.io/eng201-oer/pages/syllabus/) and jot down 1 question you have about it</label>
</div>
<div>
  <input type="checkbox" name="uchk">
  <label for="uchk">Review the [💯 Alt-Grading System](https://visforvali.github.io/eng201-oer/pages/alt-grading/) policy and jot down 1 question you have about it</label>
</div>
<div>
  <input type="checkbox" name="uchk">
  <label for="uchk">Skim the whole [🗓️ Calendar](https://visforvali.github.io/eng201-oer/) and write down class times & modalities and reading & writing deadlines in your personal comprehensive digital or analog planner</label>
</div>
<div>
  <input type="checkbox" name="uchk">
  <label for="uchk">Review the low- and high-stakes writing [✍️ Assignments](https://visforvali.github.io/eng201-oer/pages/assignments/)</label>
</div>
<div>
  <input type="checkbox" name="uchk">
  <label for="uchk">Check out the [🙋 FAQs](https://visforvali.github.io/eng201-oer/others/faqs/) page and jot down 1 question you'd like added to it</label>
</div>
<div>
  <input type="checkbox" name="uchk">
...
<div>
  <input type="checkbox" name="uchk">
  <label for="uchk">Complete the work outlined in [Module 1: Settling In](/eng201-oer/jekyll/2025-08-01-w1.html){:target="_blank"} by Sat</label>
</div>
<div>
  <input type="checkbox" name="uchk">
  <label for="uchk">Start [Module 2: Writing in the Disciplines](/eng201-oer/jekyll/2025-08-02-w2.html){:target="_blank"} by Sun</label>
</div>
</div>
...
Dear students: I want to welcome you to ENG 201: Writing in the Disciplines. I'm Dr. Mani, and I'll be your professor this semester. I'm an Eelam Tamil American creative-critical writer, artist, activist, and game designer. I've had chronic pain and fatigue for 20 years, taught for 19, written for 30, and have published multi- and inter-disciplinary work in both creative and scholarly forums. My server nickname is Flame Thief, a reference to *Hades 2.* My current research focuses on the rhetorics of chronic pain, interactive narrative, academic ableism, and the value of diasporic-disabled digital composition; in a former life, I was known for my work on transgressive Internet cultures. I have a Siberian cat named Athena, and my hill to die on is that writing *is* thinking, not just the menial task that happens after the thinking is done. You can learn more about me by checking out my profile on the home page Calendar and my introduction on Discord #🪪roll-call!
...
All of the coursework will be made available to you by the start of the semester, so you can pace yourself appropriately, but you should adhere to the calendar as much as possible (i.e., don't work too far ahead, try not to fall too far behind).
...
2. Begin the weekly module on Sun and share your [question post](https://visforvali.github.io/eng201-oer/pages/assignments/#weekly-question--answer-posts){:target="_blank"} in #🙋classroom on Discord by Tue 11:59pm
...
5. Usually, when qualitative research project drafts are due, you'll submit them by Sat 11:59pm
