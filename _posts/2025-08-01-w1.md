...
Welcome to Fall 2026 and and ENG 201: Writing in the Disciplines! 

To set yourself up for a successful semester, you should complete all the tasks listed under Week 1 in the [🗓️ Calendar](https://visforvali.github.io/eng201-oer/) on the home page. 
...
- [ ] Review the [📋 Syllabus](https://visforvali.github.io/eng201-oer/pages/syllabus/) and jot down 1 question you have about it
- [ ] Review the [💯 Alt-Grading System](https://visforvali.github.io/eng201-oer/pages/alt-grading/) policy and jot down 1 question you have about it
- [ ] Skim the whole [🗓️ Calendar](https://visforvali.github.io/eng201-oer/) and write down class times & modalities and reading & writing deadlines in your personal comprehensive digital or analog planner
- [ ] Review the low- and high-stakes writing [✍️ Assignments](https://visforvali.github.io/eng201-oer/pages/assignments/) 
- [ ] Check out the [🙋 FAQs](https://visforvali.github.io/eng201-oer/others/faqs/) page and jot down 1 question you'd like added to it
- [ ] Post your full list of questions to the #🗳️|its-help on Discord
- [ ] Complete the work outlined in [Module 1: Settling In](/eng201-oer/jekyll/2025-08-01-w1.html){:target="_blank"} by Sat
- [ ] Start [Module 2: Writing in the Disciplines](/eng201-oer/jekyll/2025-08-02-w2.html){:target="_blank"} by Sun
...
- [ ] Review the full [🎮 Discord Tutorial](/eng201-oer/others/discord){:target="_blank"} for instructions on customizing your server profile
- [ ] Select your roles in #🆔|get-roles on Discord
- [ ] Introduce yourself in #🪪|roll-call on Discord
- [ ] Read XXX before our first voice chat on Tue 9/1

## Our Typical Weekly Schedule

This is an ASYNC section, meaning we will never meet synchronously. All of the coursework will be made available to you by the start of the semester, so you can pace yourself appropriately, but you should adhere to the calendar as much as possible (i.e., don't work too far ahead, try not to fall too far behind).

Starting in Week 2 (9/7-9/11), I'll be available for synchronous coffee chats &mdash; a friendlier name for office hours! &mdash; on Tue 2-5 and Wed 1-3. I am not allowed to mandate these for async courses, but in the past, students have found that regularly meeting with me one-on-one helped improve their work. You can reserve coffee chats with me on [Zcal](https://zcal.co/drmani){:target="_blank"}.

**Because this is an ASYNC section, the planned workflow for each week starts on Sun and ends on Sat.** Your typical weekly workflow will look like this:

1. Check the Course Calendar for an overview of the work due in that week
2. Begin the weekly module on Sun and share your [question post](../pages/assignments/){:target="_blank"} in #🙋|classroom on Discord by Tue 11:59pm
3. Complete all readings and exercises linked in each module and listed/described on the Calendar, whether they're "for you only" practice exercises or assignment submissions
4. Finish the weekly module by Fri 11:59pm and share your [answer post](../pages/assignments/){:target="_blank"} in #🙋|classroom on Discord
5. Usually, when qualitative research project drafts are due, you'll submit them by Sat 5pm
...
All participation will transpire on Discord through async text chats. All async text chats will be held on Discord in #🙋|classroom, with certain activities transpiring in #team and other text channels. 

If this is undoable for you, either this may not be the right ENG 201 section for you, or we can come up with an alternate form of participation in which you may have to be fully self-paced and lose the benefit of collaborative classroom learning. So I can appropriately implement any changes, you must inform me if you require alternative accommodations by the end of Week 2, along with providing me with your specific access needs and documentation to that effect.
...
We all have things to contribute, and we'll all get lost and trip up along the way. Nurturing your curiosity despite those errors and learning to productively, vocally engage with discomfort is what writing and research are all about.

## About Me & Other Fun Stuff

You can learn more about me by checking out my profile on the home page Calendar and my introduction on Discord #🪪|roll-call. 

I've also curated playlists for our class, so if you're looking for music to fuel your writing sprints or get you in the mood for class, check out the [Playlist](https://visforvali.github.io/eng201-oer/pages/playlists/) page!
...
And now, let the first week of course content commence!
