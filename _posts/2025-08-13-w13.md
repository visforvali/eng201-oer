...
> ###### 🛑 Stop: Read!
> Read Johnny Saldana's [In Vivo Coding](/assets/pdfs/in_vivo_coding.pdf){:target="_blank"}, [Descriptive Coding](/assets/pdfs/descriptive_coding.pdf){:target="_blank"}, and [Process Coding](/assets/pdfs/process_coding.pdf){:target="_blank"}. 
{:.block-tip}
