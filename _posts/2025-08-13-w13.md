...
Copy all of the transcripts you coded in the exercises detailed above into one file and label each one with the interviewee’s name, the date of the interview, the platform (F2F, video conferencing technology, email), and length (time). 

List your first cycle codes and second cycle codes at the top of the document. 

Create a color scheme for your second cycle codes and color-code each line to which a second cycle code applies. (You may use the comments function instead of color coding if that's easier.) 
