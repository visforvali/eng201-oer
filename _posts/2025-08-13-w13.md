...
> ###### 🛑 Stop: Reread!
> Reread Johnny Saldana's ["An Introduction to Codes and Coding"](https://www.sagepub.com/sites/default/files/upm-binaries/24614_01_Saldana_Ch_01.pdf){:target="_blank"}, paying special attention to 
{:.block-tip}
...
> ###### 🛑 Stop: Read!
> Read Johnny Saldana's [In Vivo Coding](/eng201-oer//assets/pdfs/in_vivo_coding.pdf){:target="_blank"}, [Descriptive Coding](/eng201-oer/assets/pdfs/descriptive_coding.pdf){:target="_blank"}, and [Process Coding](/eng201-oer/assets/pdfs/process_coding.pdf){:target="_blank"}. 
{:.block-tip}
...
> ###### 🛑 Stop: Read!
> Read Johnny Saldana's [Focused Coding](){:target="_blank"}, [Pattern Coding](){:target="_blank"}, [Axial Coding](){:target="_blank"}, and [Theoretical Coding](){:target="_blank"}.
{:.block-tip}
