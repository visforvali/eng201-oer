...
Conducting secondary research requires robust information literacy, which means an understanding of when and how to assess and fact-check information. 

Caulfield's [Web Literacy for Student Fact-Checkers](../assets/pdfs/caulfield_web_literacy_for_student_fact_checkers_2017.pdf){:target="_blank} OER offers information on fact-checking in the digital age, which is especially useful when evaluating online popular sources.
