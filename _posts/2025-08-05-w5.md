---
title: 🦜 5. Exigence and Hypotheses
author: Dr. Mani
date: 2026-08-05
category: Jekyll
layout: post
...
> This is Module 5: Exigence and Hypotheses, which should be completed between 9/27-10/3. If you haven't completed everything in Module 4, go back and finish all outstanding tasks now. **Don't forget to click on and review each resource in this guide.**
{: .block-danger }
...
<div>
  <input type="checkbox" name="uchk">
  <label for="uchk">Read/watch the material in this module, including these external resources: ENG 201 Assignments, Gladd's "What Is Exigence?," Kennesaw State's "Exigency," Long et al.'s "Reading and Writing Rhetorically," and Mele's "Rhetorical Situation, Exigence, Kairos"</label>
</div>
<div>
  <input type="checkbox" name="uchk">
...
I've italicized most of the ways that I answered the "what kind?" questions more specifically. Note that the final sentence usually dictates the emphasis of the entire paper: here, readers are likely to expect that all the other issues taken up in this paper will tie into the idea of negotiating access through strategic disclosure, ergonomic tools, and particular pedagogical approaches.
...
I'll read your paper regardless of whether you inform me of its exigence, but I notice the difference between a paper that's just going through the motions and one that identifies why the issue you're investigating is relevant right now. However, the skill of invoking exigence isn't just about earning a good grade but about reinforcing the importance of your research, in and out of your discipline and the ENG 201 classroom.
...
Since Unit 1 Draft 1 is due this week, you should revisit the guidelines for the qualitative research project, on the [Assignments](/eng201-oer/pages/assignments){:target="_blank"} page. 
...
- **Primary**: On the surface, the Qualitative Research Project (QRP) asks you to inform audiences about your interpretation of a set of research data and explain why you interpreted it that way, using secondary and primary research to show where your thinking is coming from, and also to persuade your discipline that your thinking is legitimate, by synthesizing research and using writing-in-the-disciplines (WID) techniques
...
This week's module is brief with the intention that you spend more time on revising your research hypotheses and drafting your Research Introduction. I recommend you regularly revisit the assignment guidelines, review notes from your preliminary research, and check the previous modules and the discussion in the #🙋classroom channel on Discord for information that might help you think about how to develop your research hypotheses and construct your Research Introduction.
...
Dr. Mani's ENG 201 | High-Stakes Writing in [Assignments](https://visforvali.github.io/eng201-oer/pages/assignments/){:target="_blank"}
...
Kate Mele | [Rhetorical Situation, Exigence, Kairos](https://pressbooks.calstate.edu/navigating/chapter/exigence-and-rhetorical-situation/){:target="_blank"}

> ###### Finished? 🥳
> Have you completed everything in this module, including any practice writing activities and low-stakes Discord posts? If you did, congratulations on completing Module 5, and take a well-deserved break! If not, go back and finish what you skipped. In either case, don't forget to begin the next module by Sunday!
{: .block-warning }