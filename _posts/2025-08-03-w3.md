...
> This is Module 3: Grounded Theory for (All) Research, which should be completed between 9/13-9/19. If you haven't completed everything in Module 2, go back and finish all outstanding tasks now. **Don't forget to click on and review each resource in this guide.**
{: .block-danger }
...
> ###### 🛑 Stop: Read!
Pacheco-Vega describes the AIC technique in [Finding the Most Relevant Information in a Paper When Reading: A Three-Step Method](../assets/pdfs/raul_pacheco-vega_finding_the_most_relevant_information_in_a_paper_when_reading_aic.pdf){:target="_blank"}. 
{:.block-warning}
